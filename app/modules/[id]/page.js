...
const Product = ({ params }) => {
  ...
  if (!Object.keys(product).length > 0) return <div className='text-center'>Loading...............</div>
  return (
    <>
      <Header/>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt={title} className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 object-contain object-center rounded" src={image} />
